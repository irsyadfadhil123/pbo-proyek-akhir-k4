 ...
 */
public class CatatanPenjualan extends javax.swing.JFrame {
...
private void show_table() {
        ...
        try {
            pst = con.prepareStatement("SELECT p.id_penjualan, p.tanggal, sb.nama_barang, p.jumlah_barang, p.uang_masuk, p.catatan FROM penjualan p JOIN stokbarang sb ON p.id_barang = sb.id_barang ORDER BY p.tanggal DESC");
            rs = pst.executeQuery();
            ResultSetMetaData RSMD = rs.getMetaData();
            CC = RSMD.getColumnCount();

            DefaultTableModel DFT = (DefaultTableModel) TabelPenjualan.getModel();
            ...
            while (rs.next()) {
                ...
                for (int i = 1; i <= CC; i++) {
                    v2.add(rs.getString("id_penjualan"));
            ...
            Logger.getLogger(CatatanPenjualan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        TabelPenjualan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Penjualan", "Tanggal", "ID Barang", "Jumlah Barang", "Uang Masuk", "Catatan"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatatanPenjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CatatanPenjualan().setVisible(true);
            }
        });
    }
