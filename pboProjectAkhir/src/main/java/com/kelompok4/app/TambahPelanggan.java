...
public class TambahPelanggan extends javax.swing.JFrame {
    ...
    String idPelanggan = inputIDPelanggan.getText();
        ...
        try {
            kontakPelanggan = Integer.parseInt(inputKontakPelanggan.getText());
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Harap masukkan angka yang valid untuk id pelanggan, nama pelanggan, dan kontak pelanggan.");
            return;
        }

        try {
            Connection conn = Database.getConnection();
            String sql = "INSERT INTO pelanggan (id_pelanggan, nama_pelanggan, kontak_pelanggan) VALUES (?, ?, ?)";
            PreparedStatement pst = conn.prepareStatement(sql);
            pst.setString(1, idPelanggan); 
            pst.setString(2, namaPelanggan);
            pst.setInt(3, kontakPelanggan);
            pst.executeUpdate();
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Terjadi kesalahan saat menambahkan pelanggan: " + e.getMessage());
        }
