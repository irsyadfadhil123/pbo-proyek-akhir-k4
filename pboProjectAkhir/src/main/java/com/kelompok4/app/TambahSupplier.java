...
public class TambahSupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelContent.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, -1, -1));
        ...
        panelContent.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, -1, -1));
        ...
        panelContent.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 160, -1));
        ...
        panelContent.add(inputNamaSupplier, new org.netbeans.lib.awtextra.AbsoluteConstraints(242, 73, 400, 25));
        ...
        panelContent.add(inputKontakSupplier, new org.netbeans.lib.awtextra.AbsoluteConstraints(242, 125, 400, 25));
    ...
    private void buttonTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonTambahMouseClicked
        ...
        String kontakSupplier = inputKontakSupplier.getText();

        if (namaSupplier.isEmpty() || kontakSupplier.isEmpty()) {
        ...
        try {
            ...
            String query = "INSERT INTO supplier (nama_supplier, kontak_supplier) VALUES (?, ?)";
            PreparedStatement preparedStatement = connection.prepareStatement(query);
            preparedStatement.setString(1, namaSupplier);
            preparedStatement.setString(2, kontakSupplier);
