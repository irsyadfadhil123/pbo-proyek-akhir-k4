...
public class EditProfile extends javax.swing.JFrame {
    ...
    public void EditProfile_Load()
    {
        int c;
        
        try {
            pst = con.prepareStatement("select * from pemilikusaha");
            rs = pst.executeQuery();
            ...
            while(rs.next())
            {
                ...
                for(int i =1; i<=c; i++)
                {
                    v2.add(rs.getString("id_pemilik"));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 79, 417, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(472, 79, 365, 360));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int id_pemilik = Integer.parseInt(d1.getValueAt(selectIndex, 0).toString());
        ...
        try {
            pst = con.prepareStatement("update pemilikusaha set full_name = ?, email = ?, password = ? where id_pemilik = ? ");
            pst.setString(1, name);
            pst.setString(2, email);
            pst.setString(3, password);
            pst.setInt(4, id_pemilik);
            int k = pst.executeUpdate();
            
            if(k== 1)
            {
                JOptionPane.showMessageDialog(this, "Pemilik Usaha Updated ");
