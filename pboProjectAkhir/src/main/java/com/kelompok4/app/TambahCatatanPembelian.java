 ...
 */
public class TambahCatatanPembelian extends javax.swing.JFrame {

    /**
     * Creates new form landingPage
     */
    public TambahCatatanPembelian() {
    ...
    private void initComponents() {
        ...
        panelContent.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 110, 129, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setLabelFor(inputTanggal);
        jLabel3.setText("Tanggal:");
        panelContent.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 75, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("Jumlah Barang:");
        panelContent.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 160, 129, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Uang Keluar:");
        panelContent.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, 129, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("Catatan:");
        panelContent.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 129, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("Tambah Catatan Pembelian");
        panelContent.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, 244, -1));
        ...
        panelContent.add(inputJumlahBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(248, 159, 400, 25));

        inputUangKeluar.setBackground(new java.awt.Color(255, 255, 255));
        inputUangKeluar.setForeground(new java.awt.Color(0, 0, 0));
        panelContent.add(inputUangKeluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(248, 202, 400, 25));

        inputCatatan.setBackground(new java.awt.Color(255, 255, 255));
        inputCatatan.setForeground(new java.awt.Color(0, 0, 0));
        panelContent.add(inputCatatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(248, 245, 400, 25));
        ...
        panelContent.add(inputNamaBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(248, 113, 400, 25));

        inputTanggal.setBackground(new java.awt.Color(255, 255, 255));
        panelContent.add(inputTanggal, new org.netbeans.lib.awtextra.AbsoluteConstraints(248, 70, 400, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahCatatanPembelian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TambahCatatanPembelian().setVisible(true);
            }
        });
    }
